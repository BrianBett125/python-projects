...
# larger numbers in python# compare two numbers using else-if statement and output smaller and
# larger numbers in python
# Taking user input for two numbers
num1 = float(input("Enter the first number: "))
num2 = float(input("Enter the second number: "))# compare two numbers using else-if statement and output smaller and
# larger numbers in python
# Taking user input for two numbers
num1 = float(input("Enter the first number: "))
